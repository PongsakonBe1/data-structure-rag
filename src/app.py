...
FORCED_VISUAL_BACKEND = "colpali_endpoint"
...
VISUAL_GROUNDING_MIN_FACTS = max(1, int(os.getenv("VISUAL_GROUNDING_MIN_FACTS", "2")))
VISUAL_GROUNDING_MIN_OPERATION_FACTS = max(VISUAL_GROUNDING_MIN_FACTS, int(os.getenv("VISUAL_GROUNDING_MIN_OPERATION_FACTS", "3")))
VISUAL_GROUNDING_MIN_STEP_COVERAGE = max(0.0, min(1.0, float(os.getenv("VISUAL_GROUNDING_MIN_STEP_COVERAGE", "0.40"))))
