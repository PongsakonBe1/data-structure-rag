...
| retrieval_hit_at_k | True | 1.0 | >=0.95 |
| figure_hit_at_k | True | 1.0 | >=0.90 |
| endpoint_nonempty_rate | True | 1.0 | >=0.95 |
| candidate_image_coverage_mean | True | 1.0 | >=0.90 |
| filter_survival_rate | True | 0.04788 | >=0.01 |
| task_page_recall_at_k | True | 1.0 | >=0.95 |
| task_operation_coverage | True | 0.666667 | >=0.40 |
